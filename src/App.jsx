...
<label>Your MITO Points (Expedition Campaign)</label>
  ...
  <label>How many Testnet $MITO did you earn?<br />
    <span className="text-sm text-blue-300">
      You can calculate it using <a href="https://murinxda.budibase.app/app/mitosis-tools#/testnet-rank" target="_blank" rel="noopener noreferrer" className="underline">this testnet rank calculator</a>
    </span>
  </label>
